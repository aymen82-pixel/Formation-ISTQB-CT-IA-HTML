...
const CTAI_DATA = {
  ...
  keywordDefinitions: {
    ...
    "ML functional performance metrics": "Suites de mesures pour évaluer la performance fonctionnelle d'un modèle ML, comme accuracy, precision, recall, AUC et autres métriques pertinentes.",
    ...
    "expert system": "Système IA classique à base de règles encodant la connaissance d'experts.",
    "AI as a Service (AIaaS)": "Fourniture de capacités IA via un service cloud, souvent accessible par API.",
    "AI development framework": "Cadre logiciel ou bibliothèque qui facilite le développement et le déploiement d'applications IA.",
    "AI-based system": "Système intégrant un composant IA pour prendre des décisions ou des prédictions.",
    "GDPR (General Data Protection Regulation)": "Règlement européen sur la protection des données personnelles, applicable aux systèmes traitant des données personnelles.",
    "Input data testing": "Test de la qualité, de la représentativité et de la conformité des données d'entrée.",
    "ML algorithm": "Procédé mathématique utilisé pour apprendre des modèles à partir de données.",
    "ML framework": "Bibliothèque ou plateforme qui facilite le développement, l'entraînement et le déploiement de modèles ML.",
    "ML functional performance criteria": "Critères mesurant la performance fonctionnelle d'un modèle ML, comme accuracy ou recall.",
    "ML model": "Instance entraînée d'un algorithme ML qui produit des prédictions ou classifications.",
    "ML model testing": "Tests visant à vérifier le comportement et la robustesse d'un modèle ML avant son utilisation.",
    "ML system": "Ensemble comprenant le modèle ML, les données, les pipelines, l'infrastructure et l_interface utilisateur.",
    "ML training data": "Données utilisées pour entraîner un modèle ML.",
    "adversarial example": "Entrée intentionnellement perturbée pour tromper un modèle ML.",
    "adversarial testing": "Tests visant à trouver des entrées malicieuses qui font échouer un modèle ML.",
    "algorithmic bias": "Biais introduit par la conception ou le fonctionnement de l'algorithme.",
    "area under curve (AUC)": "Surface sous la courbe ROC, mesurant la qualité globale d'un classifieur.",
    "artificial intelligence (AI)": "Domaine informatique visant à créer des systèmes capables d'effectuer des tâches intelligentes.",
    "augmentation": "Création de données supplémentaires par transformation de données existantes.",
    "automation bias": "Tendance des humains à trop faire confiance aux recommandations des systèmes automatisés.",
    "autonomous system": "Système capable d'agir seul sans intervention humaine continue.",
    "autonomy": "Capacité d'un système à fonctionner sans intervention humaine pendant une période donnée.",
    "back-to-back testing": "Comparaison du SUT avec un système de référence ou un pseudo-oracle.",
    "bias": "Distorsion systématique des résultats d'un système due aux données, à l'algorithme ou à la conception.",
    "big data": "Ensemble de données caractérisé par un volume, une vitesse ou une variété élevés.",
    "classification": "Tâche ML consistant à affecter un élément à une catégorie prédéfinie.",
    "classification model": "Modèle ML entraîné pour effectuer des classifications.",
    "clustering": "Regroupement de données en ensembles similaires sans étiquettes préalables.",
    "clustering algorithm": "Algorithme qui regroupe des données similaires en clusters.",
    "concept drift": "Changement des relations statistiques entre entrée et sortie après le déploiement.",
    "confusion matrix": "Tableau récapitulant TP, FP, FN et TN pour évaluer un classifieur.",
    "data labelling": "Processus d'attribution d'étiquettes correctes aux exemples de données.",
    "data pipeline": "Suite d'étapes transformant les données brutes en données prêtes pour l'entraînement ou l'inférence.",
    "data poisoning": "Attaque visant à corrompre les données d'entraînement pour dégrader le modèle.",
    "data preparation": "Nettoyage, transformation et formatage des données avant l'entraînement.",
    "deep learning (DL)": "Branche du ML basée sur des réseaux de neurones profonds.",
    "deep neural network": "Réseau de neurones avec plusieurs couches cachées.",
    "defect prediction": "Utilisation de ML pour prédire où des défauts sont susceptibles d'apparaître.",
    "error guessing": "Technique de test basée sur l'intuition du testeur pour deviner les erreurs probables.",
    "experience-based testing": "Tests basés sur l'expérience et l'expertise du testeur plutôt que sur la documentation.",
    "explainability": "Capacité à expliquer pourquoi un système a pris une décision donnée.",
    "explainable AI (XAI)": "Approches IA conçues pour rendre les décisions compréhensibles.",
    "exploratory testing": "Test simultané de conception et d'exécution, orienté vers la découverte.",
    "flexibility": "Capacité d'un système à être utilisé au-delà des exigences initiales.",
    "general AI": "IA capable de réaliser un large éventail de tâches intelligentes, comparable à un humain.",
    "graphical user interface (GUI)": "Interface utilisateur basée sur des éléments graphiques.",
    "inappropriate bias": "Biais éthiquement ou socialement inacceptable.",
    "inter-cluster metrics": "Mesures utilisées pour évaluer la séparation entre clusters.",
    "interpretability": "Facilité pour un humain de comprendre le comportement interne d'un modèle.",
    "intra-cluster metrics": "Mesures utilisées pour évaluer l'homogénéité à l'intérieur des clusters.",
    "machine learning": "Sous-discipline de l'IA où un système apprend à partir de données.",
    "machine learning (ML)": "Acronyme de machine learning.",
    "mean square error (MSE)": "Métrique de régression mesurant la moyenne des carrés des erreurs.",
    "metamorphic relation (MR)": "Relation entre les résultats attendus d'un cas source et d'un cas suivant.",
    "metamorphic testing (MT)": "Technique de test utilisant des relations métamorphiques entre entrées et sorties.",
    "model evaluation": "Évaluation de la performance d'un modèle ML sur des données de validation ou de test.",
    "model tuning": "Ajustement des hyperparamètres pour améliorer les performances d'un modèle.",
    "multi-agent system": "Système composé de plusieurs agents IA interagissant.",
    "multi-layer perceptron": "Réseau de neurones avec plusieurs couches de neurones.",
    "narrow AI": "IA spécialisée dans une tâche unique.",
    "neural network": "Ensemble de neurones artificiels connectés en couches.",
    "neuron coverage": "Mesure de test comptant les neurones activés au moins une fois.",
    "non-deterministic system": "Système pouvant produire des résultats différents pour les mêmes entrées.",
    "outlier": "Observation qui s'écarte significativement du reste des données.",
    "overfitting": "Modèle qui apprend trop les détails du training set et perd en généralisation.",
    "pairwise testing": "Technique testant toutes les paires de combinaisons de paramètres.",
    "perceptron": "Neurone artificiel simple utilisé dans les réseaux de neurones.",
    "precision": "TP/(TP+FP), métrique de classification mesurant la fiabilité des positifs.",
    "probabilistic system": "Système dont les résultats sont exprimés en probabilités.",
    "pseudo-oracle": "Système de référence alternatif utilisé quand l'oracle exact est absent.",
    "recall": "TP/(TP+FN), métrique de classification mesurant la détection des positifs.",
    "receiver operating characteristic (ROC) curve": "Courbe montrant le compromis entre sensibilité et spécificité.",
    "regression": "Tâche ML où la sortie est une valeur numérique continue.",
    "regression model": "Modèle ML conçu pour prédire des valeurs continues.",
    "reinforcement learning": "Type d'apprentissage où un agent apprend via récompenses et punitions.",
    "reward hacking": "Comportement où le système optimise la récompense de façon inattendue et nuisible.",
    "robustness": "Capacité du système à résister aux perturbations et aux entrées inattendues.",
    "sample bias": "Biais causé par un échantillon d'entraînement non représentatif.",
    "self-learning system": "Système qui se modifie automatiquement pendant son fonctionnement.",
    "side effects": "Conséquences non désirées d'un changement ou d'une adaptation du système.",
    "sign change coverage": "Mesure de test pour les neurones passant de positif à négatif.",
    "sign-sign coverage": "Mesure de test portant sur les changements de signe successifs entre neurones.",
    "silhouette coefficient": "Métrique évaluant la qualité d'un clustering.",
    "supervised learning": "Apprentissage à partir de données étiquetées.",
    "technological singularity": "Point hypothétique où l'IA dépasse l'intelligence humaine.",
    "test dataset": "Données utilisées pour évaluer définitivement un modèle après l'entraînement.",
    "test oracle problem": "Difficulté à définir le résultat attendu pour une application, en particulier IA.",
    "threshold coverage": "Mesure de test pour les neurones activés au-dessus d'un seuil.",
    "tours": "Technique d'exploratory testing structurée en parcours.",
    "trained model": "Modèle ML déjà entraîné.",
    "training data": "Données utilisées pour entraîner un modèle.",
    "transfer learning": "Réutilisation d'un modèle pré-entraîné dans un nouveau domaine.",
    "transparency": "Capacité à comprendre la conception et l'implémentation d'un système.",
    "underfitting": "Modèle trop simple qui ne capture pas les patterns des données.",
    "unsupervised learning": "Apprentissage sans données étiquetées pour découvrir des structures.",
    "validation dataset": "Données utilisées pour ajuster le modèle pendant l'entraînement.",
    "value change coverage": "Mesure de test pour les neurones dont la valeur d'activation change de plus d'un seuil prédéfini."
  }
};
...
CTAI_DATA.questions = [
  // ====== MAIN SET (40 questions) ======
  {
    ...
    stem: "Lequel des énoncés suivants illustre le MIEUX « l'effet IA » ?",
    options: [
      "Des personnes perdent leur emploi car des systèmes IA réalisent leur travail à moindre coût et de manière plus efficace",
      "Les jeux compétitifs perdent de la popularité parce que les systèmes IA gagnent toujours",
      "Les systèmes experts à base de règles pour le diagnostic médical ne sont plus considérés comme de l'IA",
      "Les gens pensent que l'IA va prendre le contrôle du monde, comme le montrent les films"
    ],
    correct: ["c"],
    justifications: [
      "Incorrect. Des emplois peuvent être remplacés par l'IA, mais cela relève du progrès, pas de l'effet IA.",
      "Incorrect. La popularité des jeux n'est pas forcément liée au fait que l'IA gagne.",
      "Correct. L'effet IA = la définition de l'IA change avec le temps ; certains systèmes experts autrefois considérés comme IA ne le sont plus.",
      "Incorrect. La peur inspirée par les films n'est pas l'effet IA."
    ]
  },
  {
    id: 2, set: "main", points: 1, lo: "AI-1.4.1", kLevel: "K1", chapter: 1, multi: false,
    stem: "Laquelle des options suivantes N'EST PAS une technologie utilisée pour implémenter l'IA ?",
    options: [
    ...
    correct: ["c"],
    justifications: [
      "Incorrect. SVM est une technique de ML.",
      "Incorrect. Un arbre de décision est une technique de ML.",
      "Correct. 'Evolutionary reasoning' n'est pas une technologie standard (les algorithmes évolutionnaires existent, mais pas cette formulation).",
      "Incorrect. L'optimisation bayésienne est utilisée en ML."
    ]
  },
  {
    id: 3, set: "main", points: 1, lo: "AI-1.6.1", kLevel: "K2", chapter: 1, multi: false,
    stem: "Laquelle des affirmations suivantes concernant le matériel utilisé pour implémenter des systèmes IA est la PLUS susceptible d'être CORRECTE ?",
    options: [
      "Les processeurs utilisés pour entraîner un système de recommandation mobile doivent être les mêmes que ceux du téléphone mobile",
      "Les unités de traitement graphique (GPU) sont un choix raisonnable pour implémenter un système de vision par ordinateur basé sur l'IA",
      "Les systèmes de deep learning doivent être entraînés, évalués et testés en utilisant des puces spécifiques à l'IA",
      "Il est toujours préférable de choisir des processeurs avec plus de bits pour obtenir une précision suffisante pour les systèmes IA"
    ],
    correct: ["b"],
    justifications: [
      "Incorrect. L'entraînement et l'inférence sont des activités différentes — il n'est pas nécessaire d'utiliser le même processeur.",
      "Correct. Les GPU sont conçus pour le calcul parallèle et conviennent bien au traitement d'images pour la vision par ordinateur.",
      "Incorrect. On peut entraîner des modèles de deep learning sans puces spécifiques, même si elles accélèrent le processus.",
      "Incorrect. La précision arithmétique élevée n'est pas toujours nécessaire pour les systèmes IA probabilistes."
    ]
  },
  {
    id: 4, set: "main", points: 1, lo: "AI-1.8.1", kLevel: "K2", chapter: 1, multi: false,
    stem: "Vous envisagez d'utiliser un modèle pré-entraîné de bonne qualité pour un classifieur d'images. En interrogeant le fournisseur sur les données d'entraînement et leur format, quel risque cherchez-vous principalement à atténuer ?",
    options: [
      "La mauvaise précision de classification des modèles pré-entraînés",
      "Des différences entre les données d'entraînement du modèle et les données opérationnelles",
      "Des problèmes d'efficacité de performance du modèle pré-entraîné",
      "Un manque d'explicabilité du modèle pré-entraîné par rapport à un modèle entraîné par vous"
    ],
    correct: ["b"],
    justifications: [
      "Incorrect. La question suppose un modèle de bonne qualité, donc la précision n'est pas l'hypothèse principale.",
      "Correct. Le risque clé est l'inadéquation entre les données d'entraînement et les données opérationnelles.",
      "Incorrect. La performance n'est pas l'objectif principal de cette question.",
      "Incorrect. L'explicabilité ne se déduit pas directement des métadonnées des données d'entraînement."
    ]
  },
  {
    id: 5, set: "main", points: 1, lo: "AI-2.2.1", kLevel: "K2", chapter: 2, multi: false,
    stem: "Laquelle des affirmations suivantes décrit le mieux une exigence d'autonomie pour un système IA ?",
    options: [
      "Le système doit maintenir une distance de sécurité par rapport aux autres véhicules tant que le frein ou l'accélérateur n'est pas actionné par le conducteur",
      "Le système doit apprendre le style de réponse préféré aux e-mails en surveillant à distance le trafic de courriels",
      "Le système doit comparer ses prédictions de prix des logements avec les prix réels pour déterminer s'il doit être ré-entraîné",
      "Il doit être possible de modifier le comportement du système pour qu'il fonctionne avec différents types d'utilisateurs en moins d'une journée"
    ],
    correct: ["a"],
    justifications: [
      "Correct. Cette exigence définit la condition d'arrêt de l'autonomie (intervention humaine).",
      "Incorrect. Ceci décrit un mécanisme de self-learning plutôt qu'une exigence d'autonomie.",
      "Incorrect. Ceci concerne la gestion du concept drift, pas directement l'autonomie.",
      "Incorrect. Ceci définit une exigence d'adaptabilité."
    ]
  },
  {
    id: 6, set: "main", points: 1, lo: "AI-2.4.1", kLevel: "K2", chapter: 2, multi: false,
    stem: "Laquelle des affirmations suivantes au sujet du biais dans les systèmes IA N'EST PAS correcte ?",
    options: [
      "Le biais peut être causé par des utilisateurs d'un système de recommandation qui manipulent leurs choix pour obtenir de mauvaises suggestions",
      "Le biais peut être causé dans un système de prédiction de l'âge de décès en utilisant des données d'entraînement provenant uniquement de patients retraités",
      "Le biais peut être causé dans un système d'évaluation de la solvabilité en utilisant des données provenant uniquement de titulaires de carte de crédit",
      "Le biais peut être causé dans un système de navigation en utilisant un algorithme de planification de route trop complexe pour être expliqué aux utilisateurs"
    ],
    correct: ["d"],
    justifications: [
      "Incorrect. Le biais peut effectivement résulter d'attaques ou de manipulations des utilisateurs.",
      "Incorrect. Le sample bias se produit si l'échantillon n'est pas représentatif.",
      "Incorrect. L'utilisation d'un échantillon non représentatif génère un biais similaire.",
      "Correct. L'absence d'explicabilité est un problème d'explainability, pas nécessairement de biais."
    ]
  },
  {
    id: 7, set: "main", points: 1, lo: "AI-2.6.1", kLevel: "K2", chapter: 2, multi: false,
    stem: "Lequel des exemples suivants est le PLUS susceptible d'illustrer le reward hacking ?",
    options: [
      "Un assistant de programmation optimise le code pour réduire les temps de réponse tout en respectant les exigences fonctionnelles",
      "Un dispositif d'approvisionnement en anesthésie, dont l'objectif est de maintenir les patients stables, administre trop de doses et les patients ne se réveillent pas correctement",
      "Une organisation paie ses développeurs IA en fonction du nombre de lignes de code écrites",
      "Un type d'IA utilisé pour jouer à des jeux contre des humains se concentre uniquement sur l'obtention du score le plus élevé"
    ],
    correct: ["b"],
    justifications: [
      "Incorrect. L'outil atteint ses objectifs sans effets secondaires indésirables.",
      "Correct. Le système atteint l'objectif au détriment d'un autre objectif implicite (réveil du patient) — typique du reward hacking.",
      "Incorrect. Il s'agit d'un mode de rémunération, pas de reward hacking du modèle.",
      "Incorrect. Maximiser le score est le comportement attendu, pas nécessairement du hacking."
    ]
  },
  {
    id: 8, set: "main", points: 1, lo: "AI-2.8.1", kLevel: "K1", chapter: 2, multi: false,
    stem: "Étant donné les attributs suivants pour un système IA : I. Probabiliste, II. Explicable, III. Inéquitable, IV. Non-déterministe, V. Déterministe. Quelle combinaison ci‑dessous est la PLUS susceptible de poser des difficultés si le système doit être utilisé dans un contexte lié à la sécurité ?",
    options: [
      "I, IV",
      "II, IV",
      "II, III, V",
    ...
    correct: ["a"],
    justifications: [
      "Correct. Probabiliste + Non-déterministe rend la sécurité très difficile à garantir.",
      "Incorrect. Explicable est généralement souhaitable pour la sécurité.",
      "Incorrect. Déterministe et explicable sont préférables pour la sécurité.",
      "Incorrect. Déterministe est souhaité pour des systèmes de sécurité."
    ]
  },
  {
    id: 9, set: "main", points: 1, lo: "AI-3.1.1", kLevel: "K2", chapter: 3, multi: false,
    stem: "Laquelle des affirmations suivantes décrit LE MIEUX la classification et la régression en apprentissage supervisé ?",
    options: [
      "La régression vérifie que les résultats de test du modèle ML ne changent pas lorsque les mêmes données de test sont exécutées",
      "La classification consiste à affecter des données non étiquetées à des classes prédéfinies",
      "La classification correspond à l'étiquetage des données avant l'entraînement du modèle",
      "La régression consiste à prédire le nombre de classes produites par le modèle ML"
    ],
    correct: ["b"],
    justifications: [
      "Incorrect. La régression produit une sortie numérique, ce n'est pas un test de non-régression.",
      "Correct. La classification affecte des entrées à l'une des classes prédéfinies.",
      "Incorrect. L'étiquetage des données est le data labelling, pas la classification.",
      "Incorrect. La régression prédit des valeurs numériques, pas un nombre de classes."
    ]
  },
  {
    id: 10, set: "main", points: 1, lo: "AI-3.1.3", kLevel: "K2", chapter: 3, multi: false,
    stem: "Lequel des exemples suivants illustre le MIEUX l'apprentissage par renforcement ?",
    options: [
      "Une application de jeu mobile ajuste son feedback, le timing des réponses et le nombre d'options proposés en fonction du montant dépensé par les joueurs",
      "Une application de traduction parcourt internet pour trouver des textes multilingues afin d'améliorer sa fonction de traduction",
      "Un système de contrôle qualité en usine utilise des caméras et l'analyse audio pour identifier les articles défectueux en se basant sur un opérateur humain",
      "Un système de prédiction des défauts de composants logiciels utilise des mesures de qualité pour identifier les composants les plus susceptibles de contenir des défauts"
    ],
    correct: ["a"],
    justifications: [
      "Correct. Le montant dépensé constitue la fonction de récompense et le système ajuste son comportement pour l'augmenter.",
      "Incorrect. Ceci est du supervised learning (texte source + traduction correcte).",
      "Incorrect. Ceci est du supervised learning avec un opérateur humain comme référence.",
      "Incorrect. Probablement du supervised learning basé sur des historiques."
    ]
  },
  {
    id: 11, set: "main", points: 2, lo: "AI-3.3.1", kLevel: "K3", chapter: 3, multi: false,
    stem: "On vous demande votre avis sur l'approche ML à utiliser pour un nouveau système de gestion du trafic d'une SMART city. Le système contrôlera les feux pour fluidifier le trafic en ville. Laquelle des approches suivantes est LA PLUS susceptible de réussir ?",
    options: [
      "Apprentissage non supervisé basé sur l'identification de clusters dans la ville où la densité de trafic est supérieure à la moyenne",
      "Solution de régression supervisée basée sur des milliers de trajets étiquetés avec longueur et durée",
      "Apprentissage par renforcement basé sur une fonction de récompense qui pénalise les solutions entraînant une augmentation de la congestion",
      "Solution de classification supervisée basée sur des itinéraires favoris soumis par conducteurs et passagers"
    ],
    correct: ["c"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Lorsqu'il a testé un modèle entraîné, un ingénieur ML a constaté que le modèle était très précis sur les données de validation mais très mauvais sur des données de test indépendantes. Quelle est la cause la PLUS probable ?",
    options: ["Sous-apprentissage (Underfitting)", "Dérive du concept (Concept drift)", "Sur-apprentissage (Overfitting)", "Mauvais critères d'acceptation"],
    correct: ["c"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Lequel des éléments suivants illustre un défi probable lors du développement et du test d'une solution ML ?",
    options: [
      "Les opérations d'anonymisation des données nécessitent typiquement la connaissance de divers algorithmes ML",
      "Les données utilisées peuvent être des données non structurées",
      "Une grande part du budget est dépensée uniquement pour la préparation des données",
      "La scalabilité du pipeline de données est un défi lors de l'entraînement du modèle"
    ],
    correct: ["c"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Le data scientist se plaint que le modèle ne peut pas être entraîné avec un algorithme particulier, alors que d'autres algorithmes fonctionnent avec les mêmes données. Quelle est la raison la PLUS probable ?",
    options: ["Données incorrectes", "Données manquantes", "Données mal étiquetées", "Données insuffisantes"],
    correct: ["d"],
    justifications: [
  ...
  },
  {
    ...
    stem: "DataSure est une start-up proposant d'améliorer la qualité des modèles ML en vérifiant si les données sont correctement étiquetées. Lequel des défauts suivants est LE PLUS susceptible d'être évité en utilisant ce produit ?",
    options: [
      "Le modèle aura des vulnérabilités de sécurité",
      "Le modèle aura une faible précision",
      "Le modèle ne remplira pas sa fonction prévue",
      "Le modèle produira des sorties biaisées"
    ],
    correct: ["b"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Un ingénieur ML, manquant de données d'entraînement, fait pivoter des images étiquetées pour créer des données supplémentaires. Quelle approche d'étiquetage est appliquée ici ?",
    options: ["Crowdsourcing", "Augmentation", "Étiquetage assisté IA", "Externalisation"],
    correct: ["b"],
    justifications: [
  ...
  },
  {
    ...
    stem: "La matrice de confusion pour un classifieur d'images est : TP=78, FP=22, FN=6, TN=14. Laquelle des options représente la précision du classifieur ?",
  ...
  },
  {
    ...
    stem: "ThermalSpace aide des centrales thermiques à optimiser leur production via un modèle ML entraîné sur des données historiques étiquetées. Quelle métrique fonctionnelle ML est la PLUS susceptible d'être utilisée pour évaluer la qualité du modèle ?",
    options: ["R-squared", "Précision (Precision)", "Rappel (Recall)", "Faux positifs"],
    correct: ["a"],
    justifications: [
  ...
  },
  {
    ...
    stem: "KnowYourPet est une appli ML qui détermine si un animal a faim. Les chiens sont généralement non affamés dans les données d'entraînement. Si un chien est mal diagnostiqué comme affamé, cela peut entraîner une suralimentation et des problèmes de santé. Quelle métrique choisiriez-vous pour évaluer la pertinence du modèle ?",
    options: ["Accuracy", "Précision (Precision)", "Rappel (Recall)", "F1-score"],
    correct: ["b"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Laquelle des options suivantes décrit LE MIEUX un réseau de neurones profond ?",
    options: [
      "Il est composé d'une structure hiérarchique de neurones où les neurones les plus profonds prennent la plupart des décisions",
      "Il est composé de neurones connectés où chaque neurone a un biais associé et chaque connexion un poids associé",
      "Il est constitué de plusieurs couches où chaque couche (sauf entrée et sortie) est connectée à toutes les autres couches et les erreurs sont rétropropagées",
      "Il est composé de couches de neurones, chacune générant une valeur d'activation basée sur les autres neurones de la même couche"
    ],
    correct: ["b"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Laquelle des affirmations suivantes décrit CORRECTEMENT une mesure de couverture pour les réseaux de neurones ?",
    options: [
      "La value change coverage repose sur des neurones dont les activations changent d'au moins un montant prédéfini",
      "La threshold coverage repose sur des neurones produisant une valeur d'activation supérieure à une valeur prédéfinie entre zéro et un",
      "La neuron coverage mesure la proportion de neurones activés au moins une fois pendant les tests",
      "La sign change coverage mesure la couverture des neurones ayant produit à la fois des valeurs d'activation positives et négatives"
    ],
    correct: ["b"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Laquelle des exigences suivantes pour un système basé sur l'IA est LA PLUS susceptible de poser un défi significatif lors des tests ?",
    options: [
      "Le système doit être plus précis que le système qu'il remplace",
      "Le composant IA du système doit avoir une précision de 100%",
      "Un opérateur humain doit pouvoir désactiver le système en 1 seconde",
      "Le système doit imiter les émotions humaines d'un joueur typique"
    ],
    correct: ["d"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Lequel des facteurs suivants, lié aux données de test, peut rendre les tests des systèmes IA difficiles ?",
    options: [
      "Sourcer des big data à haute vélocité",
      "Collecter des données à partir d'une seule source",
      "Collecter des données séparément des data scientists",
      "Récupérer des données depuis des sites web publics"
    ],
    correct: ["a"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Pourquoi l'exactitude des décisions humaines serait-elle prise en compte dans les tests en plus de l'exactitude des systèmes IA ?",
    options: [
      "Les décisions humaines intuitives peuvent parfois être prises plus vite que celles d'un système IA",
      "Des décisions non éthiques peuvent être prises par des humains comme par des systèmes IA",
      "L'exactitude des décisions humaines n'est pas pertinente pour tester des systèmes IA",
      "Les décisions humaines peuvent être de moindre qualité lorsqu'elles sont influencées par une recommandation IA"
    ],
    correct: ["d"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Une solution de péage basée sur le ML détermine le type des véhicules entrants à partir d'images capturées par une caméra. Différents types de caméras et résolutions existent. Les images doivent être au format jpeg et de taille 320x480 pixels pour l'entraînement et la prédiction. Le modèle doit classer les types de véhicules avec un niveau élevé de précision et être testé contre les vulnérabilités. Chaque poste de péage aura son propre système complet non connecté aux autres. Quels types de tests sont LES PLUS appropriés pour les tests système ? (Sélectionnez DEUX)",
    options: [
      "Tests pour la dérive du concept",
      "Tests adversariaux",
      "Tests de scalabilité",
      "Tests d'équité (fairness)",
      "Tests du pipeline de données"
    ],
    correct: ["b", "e"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Lequel des énoncés suivants décrit LE MIEUX un défi de test s'appliquant spécifiquement à un système auto-apprenant ?",
    options: [
      "Le système nécessite un ré-entraînement régulier et donc des tests réguliers",
      "Le système est publié régulièrement, ce qui impose des tests de régression",
      "Le système change de telle sorte que des tests précédemment passés peuvent échouer",
      "Le système nécessite un opérateur humain, requis aussi pour les tests"
    ],
    correct: ["c"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Lequel des éléments suivants n'est PAS susceptible d'être requis pour tester un système en vue de détecter un biais ?",
    options: [
      "Impliquer des utilisateurs sélectionnés connus pour être biaisés",
      "Mesurer comment les changements des entrées de test modifient les sorties",
      "Observer comment les sorties en production se corrèlent aux entrées en production",
      "Obtenir des données supplémentaires provenant d'autres sources"
    ],
    correct: ["a"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Lequel des énoncés suivants décrit LE MIEUX comment la complexité du système peut créer des défis lors des tests d'un système IA ?",
    options: [
      "Tester le biais peut nécessiter des données que l'équipe ne possède pas",
      "La génération manuelle de tests boîte blanche peut être difficile",
      "Déterminer si un système est éthique peut être subjectif",
      "Il peut être difficile de trouver des données représentatives pour entraîner un modèle"
    ],
    correct: ["b"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Un système IA est utilisé par le ministère de la Santé pour identifier des groupes de patients vulnérables. Il est entraîné sur un grand ensemble de données collectées lors de deux enquêtes : 5 000 hommes de plus de 50 ans et 25 000 femmes de plus de 30 ans. Quelles caractéristiques doivent être les PLUS soigneusement prises en compte lors de la définition des objectifs et des critères d'acceptation du système ? (Sélectionnez DEUX)",
    options: ["Adaptabilité", "Biais", "Explicabilité", "Flexibilité", "Autonomie"],
    correct: ["b", "c"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Un ingénieur ML cherche à trouver des entrées exploitables puis à ré-entraîner les modèles pour les rendre immunisés contre ces entrées. Quelle option décrit LE MIEUX l'approche utilisée ?",
    options: ["Validation", "Tests adversariaux", "Tests du pipeline de données", "Tests de scalabilité"],
    correct: ["b"],
    justifications: [
  ...
  },
  {
    ...
    stem: "Un responsable de test doit choisir des techniques de test pour un logiciel de véhicule autonome. Un grand nombre de conditions environnementales (>50) doivent être prises en compte pour sept fonctions de véhicule. Laquelle des techniques de test suivantes est LA PLUS susceptible d'être utilisée pour tester la variété de fonctions de véhicule (VF) dans différentes conditions environnementales (EC) ?",
    options: [
      "Test A/B basé sur les paramètres VF et EC",
      "Test de combinaison de tous les paramètres VF et EC",
      "Test pairwise des valeurs pertinentes de VF et EC",
      "Test back-to-back des valeurs pertinentes de VF et EC"
    ],
    correct: ["c"],
    justifications: [
      "Incorrect. Le test A/B n'est pas adapté au combinatoire.",
      "Incorrect. Tester toutes les combinaisons est quasi impossible (>50 × 7 explose).",
      "Correct. Le test pairwise est le meilleur compromis pour réduire le nombre de combinaisons sans trop sacrifier la détection.",
      "Incorrect. Le test back-to-back n'est pas adapté au combinatoire."
    ]
  },
  {
    id: 32, set: "main", points: 1, lo: "AI-9.3.1", kLevel: "K2", chapter: 9, multi: false,
    stem: "Un responsable de test décide de faire construire un système non IA ayant des fonctionnalités similaires au système IA sous test (SUT) pour soutenir les tests système. Laquelle des affirmations suivantes est la PLUS susceptible d'être CORRECTE ?",
    options: [
      "Le responsable de test a choisi le test back-to-back parce qu'il aide à résoudre le test oracle problem en utilisant un pseudo-oracle",
      "Le responsable de test a choisi le test A/B parce qu'il aide à résoudre le test oracle problem en utilisant un pseudo-oracle",
      "Le responsable de test a choisi le test back-to-back parce que les exigences non fonctionnelles du SUT peuvent être vérifiées par rapport au pseudo-oracle",
      "Le responsable de test a choisi le test A/B parce que les exigences non fonctionnelles du SUT peuvent être vérifiées par rapport au pseudo-oracle"
    ],
    correct: ["a"],
    justifications: [
      "Correct. Le test back-to-back avec un système non-IA = pseudo-oracle, résout le test oracle problem.",
      "Incorrect. Le test A/B compare une variante du SUT avec le SUT — pas un système alternatif.",
  ...
  },
  {
    ...
    stem: "Un système de recherche d'appareils mobiles basé sur l'IA... Le cas de test source renvoie {SnapHappy_X1, SnapHappy_M2, SnapHappy_M3, ClickNow_1000x, ClickNow_1000xs}. T1 ajoute la contrainte 3D camera=yes ; T2 ajoute 3D camera=no. Laquelle des options suivantes est LA PLUS susceptible d'être une liste valide de téléphones recommandés pour les cas de test suivants ?",
    options: [
      ...
      "T1: 5 téléphones — T2: 3 téléphones",
      "T1: 5 téléphones — T2: 5 téléphones"
    ],
    correct: ["b"],
    justifications: [
      "Incorrect. T1 ⊆ source et T2 ⊆ source ; mais T1 ∪ T2 doit reformer source sans chevauchement si la condition est binaire (3D oui/non).",
      "Correct. La contrainte ajoutée se découpe binairement : T1 contient les téléphones avec 3D, T2 ceux sans 3D, et ensemble ils reforment exactement le set source sans chevauchement (la relation métamorphique).",
      "Incorrect. T1 ne peut pas contenir tous les téléphones de la source (la contrainte est plus stricte).",
      "Incorrect. Idem."
    ]
  },
  {
    id: 34, set: "main", points: 1, lo: "AI-9.6.1", kLevel: "K2", chapter: 9, multi: false,
    stem: "La planification des tests système d'un système IA est en cours. Il a été suggéré d'utiliser des tests exploratoires en plus des techniques de test scriptées. Lequel des scénarios suivants est LE PLUS susceptible d'illustrer l'exécution de tests exploratoires ?",
    options: [
      "Les données d'entraînement sont visualisées à l'aide d'outils pour examiner différents aspects des données",
      "Les tests écrits en partition d'équivalence lors du cycle de test précédent sont exécutés",
      "La checklist 'ML test' de Google est utilisée",
      "Les métriques de performance fonctionnelle ML sont calculées"
    ],
    correct: ["a"],
    justifications: [
      "Correct. L'analyse exploratoire des données (EDA) est une méthode exploratoire.",
      "Incorrect. Tests scriptés.",
      "Incorrect. Testing basé sur une checklist.",
      "Incorrect. Calculer des métriques n'est pas exploratoire."
    ]
  },
  {
    id: 35, set: "main", points: 2, lo: "AI-9.7.1", kLevel: "K4", chapter: 9, multi: true,
    stem: "LAIgal systems a un produit IA pour extraire des jugements favorables pertinents analogues à une affaire juridique donnée. Le système doit être sûr face à des entrées malveillantes. Un produit open source similaire existe et est disponible. L'absence d'un oracle de test approprié est un défi lors des tests. Quelles techniques de test doivent être sélectionnées pour tester la nouvelle version lors des tests système ? (Sélectionnez DEUX)",
    options: [
      "A/B testing",
      "Back-to-back testing",
      "Adversarial testing",
      "State transition testing",
      "Calcul de métriques de performance fonctionnelle ML"
    ],
    correct: ["b", "c"],
    justifications: [
      "Incorrect. A/B testing compare deux variantes du SUT.",
      "Correct. Le test back-to-back avec le produit open source = pseudo-oracle (résout le test oracle problem).",
      "Correct. Le test adversarial est nécessaire car le système doit être sûr face aux entrées malveillantes.",
      "Incorrect. Le test de transitions d'état n'est pas suggéré par le scénario.",
      "Incorrect. Cela s'applique au model testing de classification, pas aux tests système."
    ]
  },
  {
    id: 36, set: "main", points: 1, lo: "AI-10.1.1", kLevel: "K2", chapter: 10, multi: false,
    stem: "Laquelle des affirmations suivantes est un exemple de différence entre un environnement de test pour systèmes IA et un environnement de test pour systèmes conventionnels ?",
    options: [
      "Les environnements de test pour systèmes IA peuvent nécessiter un mécanisme pour déterminer comment une décision particulière est prise",
      "Les environnements de test pour systèmes IA nécessitent des simulateurs et des environnements virtuels alors que les systèmes conventionnels n'en ont pas besoin",
      "Les environnements de test pour systèmes IA nécessitent de grandes quantités de données, alors que les systèmes conventionnels n'ont pas besoin de grandes quantités de données",
      "Les GPU sont requis pour les environnements de test des systèmes IA alors que les systèmes conventionnels n'en ont pas besoin"
    ],
    correct: ["a"],
    justifications: [
      "Correct. Les mécanismes d'explicabilité sont requis pour les environnements IA.",
      "Incorrect. Les simulateurs/environnements virtuels sont également utilisés pour les systèmes conventionnels.",
      "Incorrect. Les systèmes conventionnels peuvent aussi nécessiter beaucoup de données.",
      "Incorrect. Les GPU sont également utilisés pour d'autres systèmes (jeux, etc.)."
    ]
  },
  {
    id: 37, set: "main", points: 1, lo: "AI-11.2.1", kLevel: "K2", chapter: 11, multi: false,
    stem: "Dans laquelle des situations suivantes l'IA serait-elle LA PLUS utile pour catégoriser de nouveaux défauts ?",
    options: [
      "Un petit nombre de défauts nécessite une catégorisation sur une nouvelle application",
      "Un grand nombre de défauts est signalé sur une petite application",
      "Des données minimales sont fournies dans les rapports de défaut typiques",
      "Une nouvelle équipe de développement doit savoir quel développeur est le plus approprié pour corriger un défaut"
    ],
    correct: ["b"],
    justifications: [
      "Incorrect. Peu de défauts + nouvelle application = pas assez de données pour entraîner l'IA.",
      "Correct. Beaucoup de défauts sur une petite application offrent un bénéfice et une opportunité d'identifier des doublons.",
  ...
  },
  {
    ...
    stem: "Lequel des éléments suivants est LE PLUS susceptible d'être utilisé par un outil IA comme base pour générer des cas de test fonctionnels ?",
    options: [
      "Un test charter",
      "Une image du système sous forme de diagramme de flux",
      "Des logs de serveur web",
      "Des rapports de plantage"
    ],
    correct: ["c"],
    justifications: [
      "Incorrect. Un test charter est un focus pour l'exploratory testing, rarement une source de génération automatique.",
      "Incorrect. Une image n'est pas machine-readable.",
      "Correct. Les logs de serveur web reflètent l'usage réel et fournissent une base à l'IA pour générer des tests.",
      "Incorrect. Les rapports de plantage concernent des échecs inattendus, pas les fonctions."
    ]
  },
  {
    id: 39, set: "main", points: 1, lo: "AI-11.4.1", kLevel: "K2", chapter: 11, multi: false,
    stem: "Laquelle des options suivantes ÉNONCE CORRECTEMENT comment un outil IA peut optimiser des suites de tests de régression ?",
    options: [
      "En analysant les résultats de tests faux positifs",
      "En analysant les informations des activités de tests précédentes",
      "En utilisant des algorithmes génétiques pour créer de nouveaux cas de test",
      "En mettant à jour les résultats attendus pour contrer la dérive du concept"
    ],
    correct: ["b"],
    justifications: [
      "Incorrect. L'objectif n'est pas de réduire les faux positifs.",
      "Correct. L'optimisation passe par l'analyse des historiques d'exécution de tests.",
      "Incorrect. Les algorithmes génétiques créent de nouveaux tests, ils n'optimisent pas une suite existante.",
      "Incorrect. La dérive du concept n'est pas liée à l'optimisation des suites de régression (section 11.4)."
    ]
  },
  {
    id: 40, set: "main", points: 1, lo: "AI-11.5.1", kLevel: "K2", chapter: 11, multi: false,
    stem: "Laquelle des options suivantes ÉNONCE CORRECTEMENT comment un outil IA peut effectuer une prédiction de défauts ?",
    options: [
      "En utilisant le langage naturel pour demander aux développeurs où ils prédisent que les défauts surviendront",
      "En analysant les causes des défauts soulevés sur une base de code similaire",
      "En analysant les faux positifs de défauts",
      "En scannant le code pour identifier les défauts à l'aide de règles"
    ],
    correct: ["b"],
    justifications: [
      "Incorrect. Le NLP est de l'IA, mais pas du defect prediction.",
      "Correct. La prédiction de défauts repose sur les corrélations entre mesures code/process/personnes et défauts (sur une base de code identique ou similaire).",
      "Incorrect. Il n'est pas utile d'analyser les faux positifs pour prédire.",
      "Incorrect. Scanner du code avec des règles est de l'analyse statique, pas de la prédiction de défauts."
    ]
  },
  ...
  // ====== ADDITIONAL SET (27 questions) ======
  {
    ...
    stem: "Laquelle des affirmations suivantes à propos de l'IA est LA PLUS susceptible d'être CORRECTE ?",
    options: [
      "Un robot autonome capable d'agir comme ouvrier dans une maison, un magasin ou un bureau est un exemple d'IA générale",
      "Un robot montrant des compétences similaires à celles d'un humain est considéré comme ayant atteint la singularité",
      "Les systèmes basés sur l'IA qui prennent en charge une gamme de fonctions de gestion des tests sont considérés comme possédant une IA générale",
      "Un système basé sur l'IA qui ne peut pas accéder à Internet est dit présenter une IA étroite"
    ],
    correct: ["a"],
    justifications: [
      "Correct. L'IA générale = intelligence comparable à l'humain ; un robot polyvalent maison/boutique/bureau correspond.",
      "Incorrect. La singularité se produit quand l'IA dépasse l'humain.",
      "Incorrect. La gestion des tests est une tâche spécialisée → IA étroite.",
      "Incorrect. L'IA étroite est définie par une tâche spécifique, pas par l'accès à Internet."
    ]
  },
  {
    id: 42, set: "additional", points: 1, lo: "AI-1.3.1", kLevel: "K2", chapter: 1, multi: false,
    stem: "Laquelle des affirmations suivantes est LA PLUS susceptible de décrire un système conventionnel (par opposition à un système basé sur l'IA) ?",
    options: [
      "Ce système affecte les clients à des groupes en fonction de leurs habitudes d'achat historiques",
      "Ce système contrôle le freinage de la voiture en fonction de sa vitesse",
      "Ce système s'est appris à reconnaître des mots différents en écoutant des enregistrements",
      "Ce système détecte des anomalies à partir de son expérience d'avoir vu des anomalies dans de nombreux rayons X"
    ],
    correct: ["b"],
    justifications: [
      "Incorrect. Le clustering de clients = unsupervised learning → IA.",
      "Correct. Aucun élément ne suggère l'utilisation d'IA — système conventionnel.",
      "Incorrect. L'auto-apprentissage est de l'IA.",
      "Incorrect. L'apprentissage à partir d'exemples est du supervised learning → IA."
    ]
  },
  {
    id: 43, set: "additional", points: 1, lo: "AI-1.5.1", kLevel: "K1", chapter: 1, multi: false,
    stem: "Laquelle des options suivantes n'est PAS un framework utilisé pour développer des logiciels basés sur l'IA ?",
    options: ["scikit-learn", "CNTK", "MxNet", "EZPy-AI"],
    correct: ["d"],
    justifications: [
      "Incorrect. Bibliothèque ML libre pour Python.",
      "Incorrect. Microsoft Cognitive Toolkit, deep learning open source.",
      "Incorrect. Framework deep learning utilisé par Amazon AWS.",
      "Correct. Aucun framework IA ne porte ce nom."
    ]
  },
  {
    id: 44, set: "additional", points: 1, lo: "AI-1.7.1", kLevel: "K2", chapter: 1, multi: false,
    stem: "Laquelle des affirmations suivantes est LA PLUS susceptible de décrire un système utilisant l'IA en tant que service (AIaaS) ?",
    options: [
      "Le classificateur d'images identifie des défauts dans les boîtiers de gyroscopes produits par l'entreprise et a été construit en utilisant une approche de transfer learning afin d'être très précis",
      "Le système de direction de véhicule sous-marin basé sur l'IA utilise un composant d'évitement d'obstacles tiers basé sur des arbres de décision et l'optimisation bayésienne",
      "Le vérificateur de contrats utilise un algorithme exclusif pour déterminer les niveaux de responsabilité juridique, mais la partie tarification du contrat est vérifiée séparément par un composant d'IA générique de tarification de contrat",
      "Le système de tarification de locations de voitures est construit avec de l'IA pour prendre en charge un algorithme basé sur la demande et est hébergé dans le cloud, disponible pour tous les bureaux de location de voitures de l'entreprise"
    ],
    correct: ["c"],
    justifications: [
      "Incorrect. Classifier hyper-spécifique, pas AIaaS.",
      "Incorrect. Composant tiers embarqué et spécialisé, pas AIaaS.",
      "Correct. L'algorithme exclusif n'est PAS AIaaS, mais le composant générique de tarification l'est.",
  ...
  },
  {
    ...
    stem: "Laquelle des options suivantes est l'utilisation la PLUS probable d'une norme/réglementation pour un système basé sur l'IA ?",
    options: [
      "Utilisation de l'ISO/PAS 21448 (SOTIF) pour un sous-marin autonome sans pilote",
      "Utilisation du RGPD pour un système de prise de décision de prêt bancaire",
      "Utilisation de l'ISO 26262 pour une voiture entièrement autonome",
      "Utilisation du RGPD pour un système anti-collision de drone"
    ],
    correct: ["b"],
    justifications: [
      "Incorrect. SOTIF concerne les véhicules routiers, pas les sous-marins.",
      "Correct. Un système de prêt bancaire traite des données personnelles → le RGPD s'applique.",
      "Incorrect. Une voiture totalement autonome inclut des systèmes non-déterministes, non couverts par ISO 26262.",
      "Incorrect. Les systèmes anti-collision de drones ne traitent généralement pas de données personnelles."
    ]
  },
  {
    id: 46, set: "additional", points: 1, lo: "AI-2.1.1", kLevel: "K2", chapter: 2, multi: false,
    stem: "Laquelle des affirmations suivantes à propos de la flexibilité et de l'adaptabilité est LA PLUS susceptible d'être CORRECTE ?",
    options: [
      "L'adaptabilité est importante en apprentissage non supervisé car elle permet au modèle ML d'apprendre à partir de données sans étiquettes",
      "La flexibilité est importante en apprentissage supervisé car elle permet au modèle ML de reconnaître du sens même lorsque les données sont mal étiquetées",
      "L'adaptabilité est importante dans les systèmes d'apprentissage par renforcement car ces systèmes doivent s'adapter eux-mêmes pour optimiser leur fonction de récompense",
      "La flexibilité est importante dans les systèmes auto-apprenants car elle leur permet de s'adapter aux changements inattendus de leur environnement"
    ],
    correct: ["d"],
    justifications: [
      "Incorrect. Adaptability = être modifié de l'extérieur, pas s'adapter soi-même.",
      "Incorrect. La flexibilité n'est pas liée à l'interprétation de labels incorrects.",
      "Incorrect. Le renforcement optimise une récompense ; adaptability ne signifie pas s'auto-modifier.",
      "Correct. La flexibilité permet une utilisation hors des exigences initiales (nouveaux contextes)."
    ]
  },
  {
    id: 47, set: "additional", points: 1, lo: "AI-2.3.1", kLevel: "K2", chapter: 2, multi: false,
    stem: "Laquelle des affirmations suivantes sur l'évolution des systèmes basés sur l'IA est CORRECTE ?",
    options: [
      "Les systèmes IA auto-apprenants qui continuent de fonctionner dans le même environnement opérationnel ne sont pas censés changer de comportement",
      "Les effets secondaires ne sont pas un problème pour les systèmes IA qui se modifient pour faire face aux changements de leur environnement",
      "Les systèmes basés sur l'IA doivent se modifier eux-mêmes pour faire face aux changements des exigences système pendant le développement",
      "Les systèmes auto-apprenants qui interagissent physiquement avec des personnes doivent être gérés pour garantir que les changements du système ne sont pas dangereux"
    ],
    correct: ["d"],
    justifications: [
      ...
      "Incorrect. L'évolution concerne le post-déploiement, pas le développement.",
  ...
  },
  {
    ...
    stem: "Lequel des exemples suivants de système basé sur l'IA est LE MOINS susceptible de nécessiter une attention particulière en matière d'éthique ?",
    options: [
      "Un jeu vidéo éducatif qui enseigne aux enfants les avantages de la démocratie en les mettant au défi de devenir président",
      "Une application qui utilise des données disponibles sur les réseaux sociaux pour fournir une note de fiabilité pour les candidats à un emploi",
      "Un système autonome sous-marin auto-alimenté de cartographie marine pour créer une carte du fond marin en eaux internationales",
      "Une application mobile qui surveille l'exercice quotidien de chaque employé et les récompense par des avantages d'assurance santé"
    ],
    correct: ["c"],
    justifications: [
      "Incorrect. Cible des enfants (groupe vulnérable) avec une vision potentiellement biaisée de la démocratie.",
      "Incorrect. Risque de biais et de violations de la vie privée.",
      "Correct. La cartographie sous-marine internationale présente peu d'enjeux éthiques (autonomie humaine, prévention des dommages, équité, explicabilité).",
      "Incorrect. Risque d'inéquité envers les personnes handicapées et pression sur les employés."
    ]
  },
  {
    id: 49, set: "additional", points: 1, lo: "AI-2.7.1", kLevel: "K2", chapter: 2, multi: false,
    stem: "Laquelle des affirmations suivantes sur la transparence, l'interprétabilité et l'explicabilité des systèmes basés sur l'IA est LA PLUS susceptible d'être CORRECTE ?",
    options: [
      "L'algorithme du moteur de recherche utilisé pour former des étudiants à la technologie des moteurs de recherche a été choisi car il était considéré comme le plus explicable",
      "Le système de prêt a été considéré comme transparent car pour chaque demande de prêt il était clair pour les utilisateurs comment il décidait d'approuver ou non le prêt",
      "Les médecins étaient satisfaits du niveau d'interprétabilité du système d'oncologie basé sur des règles car ils pouvaient comprendre comment les règles données étaient implémentées dans le système",
      "Les opérateurs de drone étaient satisfaits de la transparence du système de contrôle car ils estimaient que le système répondait correctement à leurs instructions"
    ],
    correct: ["c"],
    justifications: [
      "Incorrect. Comprendre la technologie sous-jacente = interprétabilité, pas explicabilité.",
      "Incorrect. Comprendre la décision pour chaque cas = explicabilité, pas transparence.",
      "Correct. Comprendre la technologie sous-jacente (règles) = interprétabilité.",
      "Incorrect. Le système répondant correctement = correction fonctionnelle, pas transparence."
    ]
  },
  {
    id: 50, set: "additional", points: 1, lo: "AI-3.1.2", kLevel: "K2", chapter: 3, multi: false,
    stem: "Laquelle des descriptions suivantes décrit LE MIEUX l'approche non supervisée en apprentissage automatique ?",
    options: [
      "Les données et les étiquettes sont analysées pour les regrouper en clusters",
      "Un système apprend automatiquement en satisfaisant une fonction de fitness",
      "Un système s'enseigne à lui-même à atteindre des objectifs basés sur des récompenses",
      "Les données sont analysées pour identifier des patterns dans les données"
    ],
    correct: ["d"],
    justifications: [
      "Incorrect. Pas de labels en apprentissage non supervisé.",
      "Incorrect. La fonction de fitness = apprentissage par renforcement.",
      "Incorrect. L'auto-apprentissage par récompenses = apprentissage par renforcement.",
  ...
  },
  {
    ...
    stem: "Étant donné les descriptions : I. Performance via des données de validation, II. Origine des données de test identifiée, III. Modèle ajusté prêt pour le hardware, IV. Données de test pour critères de performance, V. Modèle créé à partir du code source, VI. Caractéristiques critiques identifiées. Quelle option correspond LE MIEUX à ces activités dans le workflow ML ?",
    options: [
    ...
    correct: ["b"],
    justifications: [
      "Incorrect. III = déploiement, IV = test (pas évaluation).",
      "Correct. V (code source → modèle) = Build & Compile, II (origine des données de test) = Prepare Data, I (données de validation) = Evaluate Model.",
      "Incorrect. VI est inclus dans Prepare Data mais II l'est aussi ; IV = test, pas évaluation.",
      "Incorrect. III = déploiement."
    ]
  },
  {
    id: 52, set: "additional", points: 1, lo: "AI-3.4.1", kLevel: "K2", chapter: 3, multi: false,
    stem: "Laquelle des affirmations suivantes est LE MOINS susceptible d'être utilisée comme justification pour le choix d'un algorithme ML ?",
    options: [
      "La quantité de mémoire disponible pour entraîner le système de traduction sur l'appareil mobile",
      "Le temps maximal autorisé pour réentraîner le système de surveillance de santé embarqué",
      "Le nombre de caractéristiques mesurées utilisées comme base pour un système de prédiction sportive",
      "Le nombre de clusters attendus de types de clients pour un système de marketing de détail"
    ],
    correct: ["a"],
    justifications: [
      "Correct. Il est improbable que l'algorithme soit entraîné sur le mobile lui-même.",
      "Incorrect (c'est utile). Un système embarqué peut avoir une contrainte de temps de ré-entraînement importante.",
      "Incorrect. Le nombre de caractéristiques influence le choix du modèle.",
  ...
  },
  {
    ...
    stem: "Laquelle des affirmations suivantes sur le jeu de données de test est CORRECTE ?",
    options: [
      "Le jeu de données de test provient d'une source totalement différente de celle du jeu de validation",
      "Le format du jeu de données de test est différent de celui du jeu de validation",
      "Le jeu de données de test peut être utilisé comme jeu de validation mais pas comme jeu d'entraînement",
      "Le jeu de données de test ne doit pas être exposé au modèle pendant le processus d'entraînement"
    ],
    correct: ["d"],
    justifications: [
      "Incorrect. Test et validation proviennent typiquement de la même source.",
      "Incorrect. Les formats sont généralement identiques.",
      "Incorrect. Le jeu de test ne sert NI à l'entraînement NI à la validation.",
      "Correct. Si le jeu de test est exposé au modèle pendant l'entraînement, l'évaluation sera biaisée."
    ]
  },
  {
    id: 54, set: "additional", points: 1, lo: "AI-4.5.2", kLevel: "K1", chapter: 4, multi: false,
    stem: "Laquelle des options suivantes serait LE PLUS susceptible d'être une raison d'un mauvais étiquetage des données ?",
    options: ["Données insuffisantes", "Données synthétiques", "Erreurs de traduction", "Algorithme choisi pour le modèle ML"],
    correct: ["c"],
    justifications: [
      "Incorrect. La quantité ne détermine pas la qualité du labelling.",
      "Incorrect. Les données synthétiques ne créent pas nécessairement un mauvais labelling.",
      "Correct. Les erreurs de traduction peuvent rendre des étiquettes correctes dans une langue fausses dans une autre.",
      "Incorrect. Le choix de l'algorithme ne crée pas de mauvais labels."
    ]
  },
  {
    id: 55, set: "additional", points: 1, lo: "AI-5.3.1", kLevel: "K2", chapter: 5, multi: false,
    stem: "Une équipe ML affirme que les métriques de performance fonctionnelle basées sur des données de validation collectées dans le cadre de l'entraînement du modèle suffisent à déterminer la qualité du système. Laquelle des affirmations suivantes est une raison valable de montrer que cela peut être INCORRECT ?",
    options: [
      "Les métriques de performance fonctionnelle ML peuvent ne pas bien fonctionner si la ground truth n'est pas correcte",
      "Les métriques de performance fonctionnelle ML ne peuvent pas être utilisées pour mesurer la qualité car elles dépendent de l'outil",
      "Les données de validation sont biaisées, ce qui entraîne des mesures de performance fonctionnelle faussées",
      "Les données peuvent devoir être transformées avant l'entraînement du modèle, de sorte que les mesures de performance fonctionnelle ne reflètent pas la qualité du modèle"
    ],
    correct: ["a"],
    justifications: [
      "Correct. Si les labels sont incorrects, la ground truth est fausse et les métriques peuvent indiquer un bon modèle qui produit en fait des sorties fausses.",
      "Incorrect. Les métriques ne dépendent pas de l'outil utilisé pour les mesurer.",
      "Incorrect. Les données de validation peuvent ou non être biaisées — ce n'est pas une certitude.",
      "Incorrect. La transformation des données n'impacte pas nécessairement la qualité."
    ]
  },
  {
    id: 56, set: "additional", points: 1, lo: "AI-5.5.1", kLevel: "K2", chapter: 5, multi: false,
    stem: "Laquelle des options suivantes concernant les suites de benchmarks complète LE MIEUX l'énoncé suivant ?",
    options: [
      "Les suites de benchmarks ML aident à choisir un modèle particulier en indiquant le temps nécessaire pour l'entraînement",
      "Les suites de benchmarks ML aident à choisir un modèle particulier en indiquant le temps nécessaire pour les tests",
      "Les suites de benchmarks ML aident à choisir un modèle particulier en indiquant le temps nécessaire pour la validation",
      "Les suites de benchmarks ML aident à choisir un modèle particulier en indiquant le temps nécessaire pour le déploiement"
    ],
    correct: ["a"],
    justifications: [
      "Correct. Les suites de benchmarks indiquent les temps d'entraînement (training time) et d'inférence.",
  ...
  },
  {
    ...
    stem: "Lequel des niveaux de test suivants offre LE MEILLEUR choix pour effectuer des tests liés au biais ?",
    options: ["Tests de composants", "Tests des données d'entrée", "Tests système", "Tests de modèle"],
    correct: ["b"],
    justifications: [
      "Incorrect. Les tests de composants concernent des composants non-modèle, conventionnels.",
      "Correct. Les tests des données d'entrée sont le niveau le plus efficace pour tester le biais (idéalement avant l'entraînement).",
      "Incorrect. Les tests de biais peuvent se faire en test système, mais idéalement avant.",
      "Incorrect. Les tests de modèle vérifient que le modèle seul respecte ses critères."
    ]
  },
  {
    id: 58, set: "additional", points: 1, lo: "AI-7.5.1", kLevel: "K2", chapter: 7, multi: false,
    stem: "Laquelle des affirmations suivantes sur la documentation des composants IA est CORRECTE ?",
    options: [
      "Parce que les exigences non fonctionnelles ne font pas partie de la documentation d'un composant IA, les tests non fonctionnels ne peuvent pas être effectués",
      "Les tests en boîte blanche de l'interaction des composants IA et non IA ne sont pas possibles si les interfaces font partie de la documentation",
      "Vérifier le biais dans les données est rendu possible en incluant l'origine des données dans la documentation",
      "Les systèmes IA auto-adaptatifs exigent que chaque changement effectué par le système soit entièrement documenté"
    ],
    correct: ["c"],
    justifications: [
      "Incorrect. Les exigences non fonctionnelles font partie de la documentation.",
      "Incorrect. Documenter les interfaces SUPPORTe le test en boîte blanche.",
      "Correct. Inclure la source des données et leurs métadonnées permet de tester le biais.",
      "Incorrect. Les systèmes auto-adaptatifs ne documentent pas toujours chaque changement."
    ]
  },
  {
    id: 59, set: "additional", points: 1, lo: "AI-7.6.1", kLevel: "K2", chapter: 7, multi: false,
    stem: "Une application e-commerce recommande des produits à l'utilisateur sur la base de son historique d'achats... On vous a demandé de mesurer le taux de conversion actuel des recommandations pour le comparer au taux de conversion requis initial. Quelle est la raison sous-jacente la PLUS probable de cette demande ?",
    options: ["Effet IA", "Attaques adversariales", "Concept drift", "Manque d'équité"],
    correct: ["c"],
    justifications: [
      "Incorrect. L'effet IA = perception de l'IA changeant avec le temps.",
      "Incorrect. Les attaques adversariales sont des perturbations malveillantes, pas le scénario.",
      "Correct. Le modèle perd en précision parce que le comportement client a changé = concept drift.",
      "Incorrect. Fairness concerne un biais injuste des données, pas ce cas."
    ]
  },
  {
    id: 60, set: "additional", points: 1, lo: "AI-8.2.1", kLevel: "K2", chapter: 8, multi: false,
    stem: "Laquelle des options suivantes est LA PLUS susceptible d'être pertinente lors des tests de l'autonomie d'un système ?",
    options: [
      "Tester sur une période prolongée",
      "Tester la précision des prédictions du système",
      "Tester la rapidité d'adaptation du système",
      "Analyse statique des données d'entraînement"
    ],
    correct: ["a"],
    justifications: [
      ...
      "Incorrect. L'analyse statique des données n'est pas un test d'autonomie."
    ]
  },
  {
    id: 61, set: "additional", points: 1, lo: "AI-8.2.1", kLevel: "K2", chapter: 8, multi: false,
    stem: "Laquelle des affirmations suivantes montre comment les systèmes non déterministes peuvent créer des défis dans les tests ?",
    options: [
      "Les systèmes non déterministes produisent un résultat différent à chaque fois, empêchant normalement la génération de résultats attendus",
      "Les systèmes non déterministes sont difficiles à tester car ils ne sont pas explicables, ce qui entrave l'investigation et la correction des défauts",
      "Un système qui reçoit les mêmes entrées et l'état initial peut produire des sorties différentes, et peut donc nécessiter plusieurs exécutions de test",
      "Les systèmes non déterministes sont généralement biaisés et nécessitent des tests supplémentaires pour exclure ce biais des résultats"
    ],
    correct: ["c"],
    justifications: [
      ...
      "Correct. Description valide d'un système non déterministe — des exécutions multiples sont nécessaires pour la validité statistique.",
      "Incorrect. Il n'y a pas de corrélation directe biais/non déterminisme."
    ]
  },
  {
    id: 62, set: "additional", points: 1, lo: "AI-8.6.1", kLevel: "K2", chapter: 8, multi: false,
    stem: "Lors des tests d'un réseau de neurones profond, laquelle des caractéristiques suivantes peut être évaluée sans utiliser de tests dynamiques ?",
    options: ["Explicabilité", "Transparence", "Biais d'automatisation", "Précision"],
    correct: ["b"],
    justifications: [
      "Incorrect. Tester l'explicabilité d'un DNN nécessite une exécution.",
      "Correct. Tester la transparence = comparer la documentation à l'implémentation, aucune exécution requise.",
      "Incorrect. Le biais d'automatisation nécessite une exécution et des utilisateurs.",
      "Incorrect. La précision ne se vérifie pas sans exécution."
    ]
  },
  {
    id: 63, set: "additional", points: 1, lo: "AI-8.7.1", kLevel: "K2", chapter: 8, multi: false,
    stem: "Laquelle des caractéristiques suivantes d'un système basé sur l'IA pourrait provoquer un test oracle problem ?",
    options: [
      "On ne sait pas d'où proviennent les données d'entraînement",
      "La sortie du système est une prédiction pour laquelle la vérité terrain est inconnue",
      "Le système fonctionne sans intervention humaine et est considéré comme autonome",
      "Il y a un manque de transparence sur la façon dont le système a été implémenté"
    ],
    correct: ["b"],
    justifications: [
      "Incorrect. L'origine des données ne pose pas un test oracle problem.",
      "Correct. Si la vérité terrain est inconnue, on ne peut pas définir le résultat attendu = test oracle problem.",
      "Incorrect. L'autonomie n'a pas de lien direct avec les test oracles.",
  ...
  },
  {
    ...
    stem: "Laquelle des affirmations suivantes est CORRECTE concernant le test A/B ?",
    options: [
      "Le test A/B est également connu sous le nom de test différentiel car deux programmes différents sont utilisés pour ce type de test",
      "Le test A/B est surtout utile pour tester des modèles ML simples car il ne produit pas de résultats précis pour les modèles complexes",
      "Le test A/B nécessite plusieurs résultats attendus à partir des mêmes entrées afin de comparer des différences significatives entre les modèles testés",
      "Le test A/B est une bonne technique pour écrire des cas de test pour divers types de modèles ML, en particulier les systèmes auto-apprenants"
    ],
    correct: ["c"],
    justifications: [
      "Incorrect. Le test différentiel = back-to-back testing, pas A/B.",
      "Incorrect. A/B fonctionne pour des modèles simples ET complexes.",
      "Correct. Le test A/B nécessite des critères d'acceptation bien définis pour comparer les deux modèles.",
  ...
  },
  {
    ...
    stem: "Laquelle des affirmations suivantes est LE MOINS susceptible d'être un exemple d'avantage fourni par des environnements de test virtuels pour les tests d'un système IA ?",
    options: [
      "Une application de ville intelligente est testée dans un environnement virtuel pour permettre de tester des scénarios qui arrivent très rarement (par exemple, le contrôle de foule lors du Nouvel An)",
      "Un système de trading de marché monétaire basé sur l'IA est testé dans un environnement virtuel car il serait impraticable de tester sur de vrais marchés financiers en raison des coûts potentiels",
      "Un robot cueilleur de fruits intelligent est testé dans un environnement virtuel pour permettre l'exécution de nombreux scénarios de cueillette en un temps accéléré afin de vérifier que les fruits ne sont pas endommagés",
      "Une voiture autonome est testée dans un environnement virtuel pour permettre d'exécuter en toute sécurité des scénarios de test potentiellement dangereux"
    ],
    correct: ["c"],
    justifications: [
      "Incorrect (= un VRAI bénéfice). Tester des scénarios rares en virtuel est utile.",
      "Incorrect. Tester en virtuel pour éviter des pertes financières réelles est sensé.",
      "Correct (= PAS un vrai bénéfice). Vérifier les dégâts sur les fruits en virtuel est plus difficile que sur de vrais fruits.",
      "Incorrect. C'est une bonne pratique de tester des scénarios dangereux en virtuel."
    ]
  },
  {
    id: 66, set: "additional", points: 1, lo: "AI-11.1.1", kLevel: "K2", chapter: 11, multi: false,
    stem: "Il est possible d'utiliser un outil d'automatisation de test assisté par l'IA pour reconnaître des objets par traitement d'image, plutôt que d'utiliser des références à leur position. À quel type de technologie d'ingénierie logicielle basée sur l'IA cet exemple fait-il LE PLUS probablement référence ?",
    options: [
      "Classification, apprentissage et prédiction",
      "Ingénierie logicielle probabiliste",
      "Ingénierie logicielle basée sur la recherche",
      "Clustering"
    ],
    correct: ["a"],
    justifications: [
      "Correct. La reconnaissance d'images par classification (modèles de classification) reconnaît les objets dans les GUIs.",
      "Incorrect. L'ingénierie logicielle probabiliste consiste à estimer des probabilités d'événements.",
      "Incorrect. Basé sur la recherche = réduction d'un grand espace de recherche.",
      "Incorrect. Le clustering est un type d'algorithme, pas une catégorie technologique de génie logiciel."
    ]
  },
  {
    id: 67, set: "additional", points: 1, lo: "AI-11.6.1", kLevel: "K2", chapter: 11, multi: false,
    stem: "Laquelle des affirmations suivantes est CORRECTE en ce qui concerne les tests visuels ?",
    options: [
      "Les tests visuels utilisent des IDs d'objet pour déterminer les changements",
      "Les tests visuels utilisent des images pour faire des comparaisons pixel par pixel",
      "Les tests visuels aident à trouver des éléments d'interface utilisateur qui se chevauchent",
      "Les tests visuels échouent lorsque la disposition de l'écran change"
    ],
    correct: ["c"],
    justifications: [
      "Incorrect. Les tests visuels utilisent des images, pas des object IDs.",
      "Incorrect. Les tests visuels utilisent l'IA pour comparer, PAS du pixel par pixel.",
      "Correct. Les tests visuels détectent des éléments UI superposés (comme le ferait un humain).",
      "Incorrect. Les tests visuels fonctionnent malgré les changements de mise en page."
    ]
  }
];
